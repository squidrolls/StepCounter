package com.yangyijing.stepcounter.ui.view
...
import com.yangyijing.stepcounter.utils.ScreenUtil
...
class RecordsCalenderItemView(
    ...
    val position: Int, //当前item 的时间  ，如   2021年06月15日 ，  用以判断当前item是否可以被点击
