package com.yangyijing.stepcounter.service
...
import com.yangyijing.stepcounter.ui.activities.MainActivity
...
class StepService : Service(), SensorEventListener {
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        /**
         * 将Service设为前台，不然当APP结束以后很容易被GC给干掉
         */
